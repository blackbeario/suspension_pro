...
class _BikeFormState extends State<BikeForm> {
  ...
  Future<bool> _addUpdateBike() {
    ...
    db.addUpdateBike(_bikeController.text, fork, shock);
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        suffixIcon: Icon(Icons.pedal_bike_sharp, size: 24, color: CupertinoColors.activeBlue.withOpacity(0.5)),
                        isDense: true,
                        filled: true,
                        hoverColor: Colors.blue.shade100,
                        semanticCounterText: 'Must enter 3 chars',
                        counterText: _bikeController.text.length < 6 ? '${_enteredText.length.toString()} character(s)' : null,
                        ...
                        errorText: _bikeController.text.length < 6 ? 'Please enter at least 6 characters' : null,
                ...
                Visibility(
                  ...
                  maintainState: true,
                  child: ForkForm(bikeId: widget.bike, fork: fork, forkCallback: (val) => showForkForm(val)),
                ),
                Visibility(
                  child: TextButton(
                ...
                Visibility(
                  maintainState: true,
                  visible: _isVisibleShockForm,
                  child: ShockForm(bike: widget.bike, shock: shock, shockCallback: (val) => showShockForm(fork, val)),
                ),
                SizedBox(height: 20),
                widget.bike != null
                    ? CupertinoButton(
